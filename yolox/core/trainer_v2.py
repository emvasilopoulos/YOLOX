...
class TrainerV2:
    ...
    def before_train(self):
        """
        1. gets model and moves to device
        2. gets optimizer
        3. in resume_train, loads checkpoints for 2 use cases:
            1. to resume training --> also loads optimizer state + sets start_epoch
            2. to finetune from a trained model --> only loads model state
        4. gets data loader
        5. gets lr_scheduler
